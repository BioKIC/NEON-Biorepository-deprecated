...
$LANG['SKEL_EXPLAIN_P3'] = "Dans les cas où un enregistrement existe déjà, un téléchargement de fichier général remplacera complètement l'enregistrement existant par les données du nouvel enregistrement.
							D'un autre côté, un téléchargement squelettique augmentera l'enregistrement existant uniquement avec de nouvelles données de terrain. Les champs ne sont ajoutés que si les données n'existent pas déjà dans le champ cible.";

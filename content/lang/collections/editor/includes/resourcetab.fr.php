...
$LANG['OCC_MATCHES_AVAIL'] = "Correspondances d'Occurrences dDisponibles à Lier";
...
$LANG['LINK_TO_CHECKLIST_2'] = 'Lien vers Liste de contrôle en tant que Échantillon';
...
$LANG['IF_X'] = "Si un X rouge ne s'affiche pas à droite du nom de la liste, vous n'avez pas les droits de modification pour cette liste et ne pouvez donc pas supprimer le lien du échantillon sans contacter le propriétaire de la liste de contrôle";
...
$LANG['LOCUS'] = 'Lieu';
$LANG['URL'] = 'URL';
$LANG['ADD_NEW_GEN_2'] = 'Ajouter Vouvelle Ressource Génétique';

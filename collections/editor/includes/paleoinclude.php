...
<script>
	...
	function intervalChanged(elemObj){
		...
		if(rankid==10 || rankid==20){
			...
			if($("select[name=absoluteAge]").val() == '') $("select[name=absoluteAge]").val(term);
		}
	}
</script>
<fieldset>
	...
	<div id="biostratigraphyDiv">
		<?php echo (defined('BIOSTRATIGRAPHYLABEL')?BIOSTRATIGRAPHYLABEL:'Biostratigraphy'); ?>
	...
	<div id="taxonEnvironmentDiv">
		<?php echo (defined('TAXONENVIRONMENTLABEL')?TAXONENVIRONMENTLABEL:'Taxon Environment'); ?>

<?php
class OccurrenceSimpleSearchSupport {
		...
		if(isset($collGrpArr['cat'])){
			...
			<table>
				...
				foreach($categoryArr as $catid => $catArr){
						...
						<td style="width:10px;">
							<div style="margin-top: 7px">
								<a href="#" onclick="toggleCat('<?php echo $idStr; ?>');return false;">
									<img id="plus-<?php echo $idStr; ?>" src="<?php echo $CLIENT_ROOT; ?>/images/plus_sm.png" style="<?php echo (in_array($catid, $targetCatArr)||in_array(0, $targetCatArr)?'display:inline;':'') ?>" />
					...
					<tr>
						<td colspan="4">
							<div style="display:none" id="cat-<?php echo $idStr; ?>" style="<?php echo (in_array($catid, $targetCatArr)||in_array(0, $targetCatArr)?'':'').$borderStyle; ?>">
								<table>
									<?php

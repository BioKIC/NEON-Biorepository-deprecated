...
$LANG['THUMB_BUILDER'] = 'Thumbnail Builder';
$LANG['HOME'] = 'Home';
$LANG['COL_MAN_MENU'] = 'Collection Management Menu';
$LANG['SITEMAP'] = 'Sitemap';
$LANG['THUMB_MAINT_TOOL'] = 'Thumbnail Maintenance Tool';
$LANG['FIELD_IMAGES'] = 'field images';
$LANG['PROCESSING_PANEL'] = 'Processing Panel';
$LANG['START_PROCESSING'] = 'Start processing';
$LANG['NUM_IMGS_REFRESHED'] = 'Number of images to be refreshed';
$LANG['FINISHED'] = 'Finished!';
$LANG['IMG_COUNT_EXPLAIN'] = 'Image counts without thumbnails and/or basic web image display';
...
$LANG['IMAGES_AVAIL_REFRESH'] = 'Number images available for refresh';
$LANG['CATNUM_RANGE'] = 'Catalog Number Range';
$LANG['CATNUM_LIST'] = 'Catalog Number List';

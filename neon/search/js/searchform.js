...
function toggleSelectorAll() {
                               ...
                               const testURL = document.getElementById(
                                 'test-url'
                               );
                               ...
                               const taxaInput = document.getElementsByName(
                                 'taxa'
                               );
                               taxaInput[0].addEventListener(
                                 'change',
                                 updateChip
                               );
                               ...
                               function updateChip(e) {
                                 ...
                                 let eInput = document.getElementsByName(
                                   e.target.name
                                 );
                               ...
                               function getParam(paramName) {
                                 ...
                                 if (paramName === 'db') {
                                   let query =
                                     ...
                                     criterionSelected +
                                     ' input[name="db"]';
                                   let selectedInModal = Array.from(
                                     document.querySelectorAll(query)
                                   );
                                   let selectedInForm = Array.from(
                                     document.querySelectorAll(
                                       '#search-form-colls input[name="db"]'
                                     )
                                   );
                                   console.log(
                                     'Selected in Form: ',
                               ...
                               function getSearchUrl() {
                                 ...
                                 var queryString = Object.keys(paramsArr).map(
                                   (key) => {
                               ...
                               $('#neonext-collections-list')
                                 ...
                                 .bind(
                                   'click',
                                   { element: '#neonext-collections-list' },
                                   autoToggleSelector
                                 );
                               ...
                               $('.expansion-icon').click(function () {
                                 if (
                                   $(this).siblings('ul').hasClass('collapsed')
                                 ) {
                                   $(this)

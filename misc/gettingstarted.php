...
<html>
  ...
  <p>The NEON Biorepository at the <a href="https://biokic.asu.edu/collections">Arizona State University Biocollections</a>&nbsp;receives, curates, and makes nearly all of the samples collectedby the
    <a href="https://www.neonscience.org/">National Ecological Observatory Network</a>&nbsp;(NEON) available to researchers. NEON aims to provide open data that will enable researchers, educators and the public to better understand how aquatic and terrestrial ecosystems are changing over time. Funded by the National Science Foundation and operated by Battelle Memorial Institute, the network publishes over <a href="https://data.neonscience.org/home">180 standardized ecological and environmental datasets</a>&nbsp;collected
...
<button><a href="#getting-started-toc">Go back to TOC</a></button>
  ...
  <article><h3 class="anchor" id="h.ec4rhmcfzhf">Some samples have a scientific name that contains a &ldquo;/&rdquo; (e.g. &ldquo;<span style="font-style: italic">Peromyscus leucopus/maniculatus&rdquo;</span>). What do these names mean?</h3>
    ...
    <p>To request samples, navigate to the <a href="https://biorepo.neonscience.org/portal/misc/samplerequest.php">&ldquo;Sample Request&rdquo; </a>page found under &ldquo;Sample Use&rdquo; in the main menu. Make sure you
    ...
    <p>To find information about appropropriate sample uses and about how decisions to loan samples are made, navigate to the &ldquo;<a href="https://biorepo.neonscience.org/portal/misc/samplepolicy.php">Sample Use Policy</a>&rdquo;
      page found under &ldquo;Sample Use&rdquo; in the main menu. On this page you will find a brief summary of our sample use policy and a link to the full <a href="https://biorepo.neonscience.org/portal/misc/NEON-Sample-Use-Policy_20181217.pdf">NEON Sample Use Policy.</a>&nbsp;These
    ...
    <p>To find guidelines for acceptable NEON Biorepository data use, navigate to the &ldquo;<a href="https://biorepo.neonscience.org/portal/includes/usagepolicy.php">Data Usage Policy</a>&rdquo; page found under &ldquo;Sample
    ...
    <p>Under &ldquo;Additional Information&rdquo; in the NEON Biorepository data portal main menu, you will find links to overviews of the <a href="https://www.neonscience.org/">NEON project</a>, main <a href="https://www.neonscience.org/data/about-data">NEON data portal</a>,

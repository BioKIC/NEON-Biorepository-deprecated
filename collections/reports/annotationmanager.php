				...
				<th style="width:125px;text-align:center;"><?php echo $LANG['COLLECTOR']; ?></th>
						...
						<fieldset style="margin-top:15px;">
							...
							<div style="float:left;margin-left:50px">
								...
								<button type="submit" name="submitaction" onclick="changeAnnoFormTarget(this.form, 'browser')" value="Print in Browser" style="width:150px;"><? php echo $LANG['PRINT_IN_BROWSER']; ?></button>
								<?php
								if($reportsWritable){
									?>
